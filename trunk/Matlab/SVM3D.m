function [Ctrain, Ctest] = SVM3D(Ynew, Ytnew, Wnew, Wtnew)
...
figure
svmStruct = svmtrain(data, groups, 'Kernel_Function', kernel, 'showplot',false);
...
classes = svmclassify(svmStruct, datatest,'showplot',false);
